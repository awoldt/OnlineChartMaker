...
const LineChart = () => {
  const [chartTitle, setChartTitle] = useState(
    "Wildlife Population (in Millions)"
  );
        ...
        <div style={{ marginBottom: "25px" }}>
          ...
          <Collapse in={howToUseCollapse}>
            <div style={{ marginTop: "10px", maxWidth: "600px" }}>
              <p>
                Making a line chart has never been easier. All changes made will
              ...
              <p>
                ...
                displayed the 3 different datasets used are fish, zebras, and
                bears. Notice how each of these are all different lines on the
                graph with different colors. Each dataset will have values that
                are needed to be displayed alongside each label.{" "}
              </p>
              <h2>Labels</h2>
              <p>
